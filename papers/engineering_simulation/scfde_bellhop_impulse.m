...
surfaceType = field_default(bellhopOptions, "bellhopSurface", "flat");
surfaceRmsM = field_default(bellhopOptions, "bellhopSurfaceRmsM", 0.5);
cacheKey = sprintf("%.1f_%.1f_%.1f_%.2f_%d_%s_%s_%s_%.2f", ...
    ...
    bellhopOptions.carrierHz, sediment, ssp, surfaceType, surfaceRmsM);
if isfile(cacheFile)
