...
methodLabels = ["QPSK, 1濞喡ゅ嚡娴?, "CCK-disjoint, 1濞喡ゅ嚡娴?, ...
    "CCK-IBDFE, 1濞喡ゅ嚡娴?, "QPSK, 5濞喡ゅ嚡娴?, ...
    "CCK-disjoint, 5濞喡ゅ嚡娴?, "CCK-IBDFE, 5濞喡ゅ嚡娴?];
...
result.modeDefinitions = struct( ...
    "qpsk", "QPSK缁楋箑褰块弰鐘茬殸閿涘瞼顑侀崣椋庨獓鏉烆垰寮芥＃鍦汢DFE閵?, ...
    "cckDisjoint", "閺嶅洤鍣崗顐ュП閻楀構CK閺勭姴鐨犻敍宀冨П閻楀洨瀚粩濠筆SK鏉烆垰寮芥＃鍦汢DFE閵?, ...
    "cckIbdfe", "閺嶅洤鍣崗顐ュП閻楀構CK閺勭姴鐨犻敍灞界暚閺佸鐖滅€涙鎮楁灞芥綆閸婅壈钂嬮崣宥夘洯IBDFE閵?);
result.assumptions = struct( ...
    "channelKnowledge", "perfect", ...
    "channelUse", "閹碘偓閺堝膩瀵繋濞囬悽銊ф祲閸氬瞼娈戦棃娆愨偓浣哥秺娑撯偓閸栨牕顦垮鍕繆闁?, ...
    "snrDefinition", "Eb/N0閿涘本鐦℃穱鈩冧紖濮ｆ梻澹掗懗浠嬪櫤Eb=1", ...
    "coding", "閺堫亜濮為崗銉ヮ樆閻緤绱辨晶鐐垫抄娴犲懏娼甸懛鐙狟DFE鏉烆垰寮芥＃鍫ｅ嚡娴?);
...
annotation(fig, "textbox", [0.12, 0.055, 0.78, 0.055], "String", ...
    "閸?5-29  閸氬嫮顫掑Ο鈥崇础閻ㄥ嫯顕ら惍浣哄芳閹嗗厴鐎佃鐦?, ...
