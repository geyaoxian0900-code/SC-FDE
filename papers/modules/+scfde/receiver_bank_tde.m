...
equivalent = scfde.equalizers.subband_equivalent_channel( ...
    channel.impulse, channel.branchImpulses, size(channel.branches, 1));
...
target(delay + 1) = 1;
% Strict MMSE regularization: noise variance scaled by the received
% power relative to unit signal variance (no empirical constant).
