function receiver = fdda_teq(channel, source, cfg)
%FDDA_TEQ Frequency-domain direct adaptive turbo equalizer module (book 4.5.3).
...
[bits, ~, trace] = scfde.equalizers.ch4_iterate_frequency_turbo( ...
    ...
    info, permutation, inversePermutation, cfg, "Log-MAP", true);
decisions = 1 - 2 * bits;
