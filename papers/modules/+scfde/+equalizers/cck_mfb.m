...
receiver = scfde.equalizers.pack_equalizer("CCK-MFB", "cck-mfb", ...
    ...
    "effectiveParameters", struct("observationSpan", ...
        8 + numel(channel.impulse) - 1), ...
    "formulaNote", "(5-24)/(5-40)~(5-43): channel matched filter (full linear convolution, main-tap aligned) + nearest-codebook ML decision on the CMF output (matched-filter bound structure)"));
end
