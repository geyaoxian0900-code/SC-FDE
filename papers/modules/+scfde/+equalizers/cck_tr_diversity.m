...
receiver = scfde.equalizers.pack_equalizer("CCK-TR-Diversity", ...
    ...
    "formulaNote", "weakest-link certification: (5-57) equal-weight 1/2 merge after same-time-order restoration is BOOK-EXACT, but the branch chip-level soft outputs are ALG-EQUIV and the frame-head handling is ENGINEERING, so the registered method as a whole is ALG-EQUIV", ...
