...
receiver = scfde.equalizers.pack_equalizer("CSK-MF", "csk-matched-filter", ...
    ...
    "effectiveParameters", struct("codeLength", codeLength, ...
        "cskOrder", M, "users", users), ...
    "formulaNote", "(6-6)~(6-12)/(6-16)~(6-19): channel-matched dictionary correlation; under an identity channel the dictionary decision equals the (6-9) circular correlation peak (oracle-tested); the (6-16)~(6-19) conventional-CSK region remains TRANSCRIPTION-PENDING"));
end
