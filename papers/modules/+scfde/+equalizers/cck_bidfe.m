...
receiver = scfde.equalizers.pack_equalizer("CCK-BiDFE-1", "cck-bidfe", ...
    ...
    "sourceEquations", "(5-46)~(5-51)", ...
    "effectiveParameters", struct("candidateLimit", limit), ...
    "formulaNote", "(5-46)~(5-51) BiDFE-1 signal flow from book/P133.png~P137.png (2026-08-17): forward tentative DFE (5-47) before BTR (5-48), reversed DFE (5-49), bilateral cancellation (5-46) with w_i = x_i / f_i = x_i ((5-50)/(5-51)), current block never cancels itself; ALG-EQUIV because the (5-48)~(5-56) per-symbol transcription awaits human double review"));
end
