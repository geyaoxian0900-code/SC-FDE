...
receiver = scfde.equalizers.pack_equalizer("CCK-BiDFE-2", "cck-bidfe2", ...
    ...
    "formulaNote", "(5-48)~(5-56) BiDFE-2: the exact INITIALIZATION and forward/backward execution order must be established from book/31.png and book/32.png before any BOOK-EXACT claim; the current execution order is an explicit ENGINEERING choice"));
end
