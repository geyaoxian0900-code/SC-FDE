...
% cfg.fddaForgettingF/fddaForgettingB - gamma_f/gamma_b (default 0.97
%                      each; cfg.fddaForgetting is a compatibility
%                      alias for both; the book gives gamma < 1 without
%                      values)
