...
%TD_TURBO Time-domain Turbo equalizer module (spec 4.1 BCJR + LMMSE).
...
% global RNG.  The per-iteration boxed LMMSE (4-24)~(4-31) is computed
% inside ch4_iterate_time_turbo.
...
[bits, ~, trace] = scfde.equalizers.ch4_iterate_time_turbo( ...
    channel.received, channelMatrix, [], cfg.noiseVariance, ...
