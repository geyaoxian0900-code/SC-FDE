...
result.systemDefinition = struct( ...
    "transmitArray", "4 TX antennas, single-active spatial modulation", ...
    "receiveArrays", cfg.receiveCounts, ...
    "qpskReceiver", "1-round MIMO-MMSE frequency detection", ...
    "cckReceiver", "5-round joint spatial-index and full CCK codeword posterior IBDFE", ...
...
annotation(fig, "textbox", [0.12, 0.055, 0.78, 0.055], "String", ...
    "Fig 5-30: BER vs number of receive antennas", ...
