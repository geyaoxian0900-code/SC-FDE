...
methodLabels = ["CCK-Rake", "TE-CCK-iter0", "TE-CCK-iter1", ...
    "TE-CCK-iter2", "TE-CCK-iter3", ...
    "TE-CCK-iter4", "DSSS-2", "DSSS-4", "DSSS-8"];
...
annotation(fig, "textbox", [0.13, 0.055, 0.76, 0.055], "String", ...
    "Fig 5-24: DSSS vs CCK BER over simulated channel", ...
